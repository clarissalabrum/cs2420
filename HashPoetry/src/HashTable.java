...
public class HashTable<E>
{
    ...
    public boolean insert( E x )
    {
        ...
        array[ currentPos ] = new HashEntry<>( x, true, currentPos );
    ...
    private static class HashEntry<E>
    {
        ...
        public int  key;       // index value
        public boolean isActive;  // false if marked deleted

        public HashEntry( E e, int key )
        {
            this( e, true, key );
        }

        public HashEntry( E e, boolean i, int key )
        {
            element  = e;
            this.key = key;
            isActive = i;
    ...
    public static void main( String [ ] args )
    {
        ...
        System.out.println(H.insert(""+6));
        System.out.println(H.findPos("6"));

        System.out.println(H.toString(2002));
